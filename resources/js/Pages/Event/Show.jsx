...
export default function Show({ auth, evenement }) {
  ...
  const {
    ...
    setClickedEvents,
    setCountCart,
  } = useCheckedEvent((state) => ({
    notifcart: state.notifcart,
    countcart: state.countcart,
    clickedEvents: state.clickedEvents,
    setClickedEvents: state.setClickedEvents,
    setCountCart: state.setCountCart,
  }));
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mx-auto max-md:px-2">
          ...
          <div className="data w-full lg:pr-8 pr-0 xl:justify-start justify-center flex items-center max-lg:pb-10 xl:my-2 lg:my-5 my-0">
            <div className="data w-full max-w-xl">
              <h2 className="font-manrope font-bold text-3xl leading-10 text-blue-900 mb-2 capitalize ">
                {evenement.titre}
              </h2>
              <div className="flex flex-col sm:flex-row sm:items-center mb-6">
                <h6 className="font-manrope font-extrabold text-2xl leading-9 text-gray-900 pr-5 sm:border-r border-gray-200 ">
                  {evenement.prix} ${" "}
                </h6>
                <div className="flex items-center ">
                  ...
                  <span className="font-normal leading-7 text-gray-500 text-sm">
                    Créé par : {evenement.created_by.name}
                  </span>
                </div>
              </div>
              ...
              <div className="flex justify-between">
                <p className="text-base font-semibold text-blue-900 mr-10">
                  Date de début de l'événement
                </p>
                <p className="text-base font-semibold text-blue-900 mr-1">
                  Date de fin de l'événement
                </p>
              </div>
              <div className="flex justify-between">
                <p className="text-gray-500 text-base font-normal mb-5 ">
                  {evenement.start_date}
                </p>
                <p className="text-gray-500 text-base font-normal mb-5 mr-28">
                  {evenement.end_date}
                </p>
              </div>
              <div className="flex justify-between">
                ...
                <p className="text-base font-semibold text-blue-900 mr-2">
                  Date de création
                </p>
      ...
      <div className="flex items-end justify-end mr-40  mt-8">
        <button
          onClick={handleClick}
          className="absolute text-center  w-96 h-12 px-5 py-4 rounded-[100px] bg-indigo-600 flex items-center justify-center font-semibold text-lg text-white shadow-sm transition-all duration-500 hover:bg-indigo-700 hover:shadow-indigo-400"
        >
          <svg
