...
const filters = [
...

  {
    ...
    name: 'Date',
    options: [
      { value: 'start', label: 'Start Date', type: 'date', defaultValue: '', checked: false },
      { value: 'end', label: 'End Date', type: 'date', defaultValue: '', checked: false },
    ],
  },
]
...
export default function Filterside({events}) {
      ...
      <>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Evenements</h1>
