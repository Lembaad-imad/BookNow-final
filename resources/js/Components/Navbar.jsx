...
export default function Navbar({ auth, header,notifcart,countcart ,clickedEvents,setClickedEvents,setCountCart}) {
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          {!auth ? (
            ...
            <div className="hidden sm:flex sm:items-center sm:ms-6">
              <div className="ms-3 relative flex justify-center gap-5">
              <ShoppingCart notifcart={notifcart}
              countcart={countcart}
