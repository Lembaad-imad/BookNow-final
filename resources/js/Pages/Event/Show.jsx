...
export default function Create({ auth, evenement }) {
  return (
        <section className="relative">
                            ...
                            <div className="data w-full max-w-xl">
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center mb-6">
                                    ...
                                    <div className="flex items-center ">
                                        ...
                                        <span className=" font-normal leading-7 text-gray-500 text-sm ">Créé par :  {evenement.createdby.name}</span>
                                    </div>
                                </div>
          ...
          <button className="absolute text-center  w-96 h-12 px-5 py-4 rounded-[100px] bg-indigo-600 flex items-center justify-center font-semibold text-lg text-white shadow-sm transition-all duration-500 hover:bg-indigo-700 hover:shadow-indigo-400">
